...
namespace Editor.Windows
{
    public class EditorMainWindow : OdinMenuEditorWindow
    {
        ...
        private BulletPageEditor _bulletPageEditor;
        ...
        private void FillTree()
        {
            ...
            _tree.Add("Bullets/Bullet editor", _bulletPageEditor);
        ...
        private void InitPages()
        {
            ...
            _bulletPageEditor = new BulletPageEditor(_dictionaries);
            _allPages.Add(_bulletPageEditor);
        }
